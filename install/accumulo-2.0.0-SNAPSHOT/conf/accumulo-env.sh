...
export ACCUMULO_LOG_DIR=/home/mark/dev/mini-2.0.0/install/logs/accumulo
## Hadoop installation
export HADOOP_PREFIX=/home/mark/dev/mini-2.0.0/install/hadoop-2.7.5
## Hadoop configuration
export HADOOP_CONF_DIR="${HADOOP_CONF_DIR:-${HADOOP_PREFIX}/etc/hadoop}"
## Zookeeper installation
export ZOOKEEPER_HOME=/home/mark/dev/mini-2.0.0/install/zookeeper-3.4.11
...
export DEBUG_OPTS="-agentlib:jdwp=transport=dt_socket,server=y,address=5005,suspend=n"
